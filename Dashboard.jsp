...
<html>
<head>  
<title>NCDOT WIM - Dashboard</title>
<h1 align=center>NCDOT Dashboard</h1>
<script>
...
<div id="chartContainer5" style="height: 370px; max-width: 700px; margin: 0px auto; "></div>
<br/>
<div align=center>
	<div id="chartContainer1" style="height: 200px; max-width: 500px; margin: 10px auto; float:left;"></div>
...
<div id="chartContainer2" style="height: 200px; max-width: 500px; margin: 0px auto; "></div>
<br/><br/><br/>

<div id="chartContainer3" style="height: 200px; max-width: 500px; margin: 0px auto;  float:left;"></div>

<div id="chartContainer4" style="height: 200px; max-width: 500px; margin: 0px auto;"></div>
